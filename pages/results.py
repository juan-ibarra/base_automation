...
class DuckDuckGoResultPage:
    ...
    def link_div_count(self):
        """
        Devuelve la cantidad de divs con resultados
        """
    ...
    def phrase_result_count(self, phrase):
        """
        Devuelve la cantidad de frases encontradas en los resultados
        """
    ...
    def search_input_value(self):
        """
        Devuelve la frase que se encuentra en el campo de busqueda
        """
